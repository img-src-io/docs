...
```python
client.images.update_visibility(id="img_abc123", visibility="private")
```
...
# Update settings
client.settings.update_settings(request=models.UpdateSettingsRequest(
    default_quality=85,
...
# Update preset
client.presets.update_preset(
    id="preset_id",
    params={"w": 250, "h": 250, "fit": "cover"},
)

# Delete preset
client.presets.delete_preset(name="thumbnail")
```
...
```python
from img_src import Imgsrc
from img_src.errors import ImgsrcError, ImgsrcDefaultError
