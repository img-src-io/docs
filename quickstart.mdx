...
| **JXL** <Tooltip tip="Very limited browser support (~12%). Only Safari 17+ partial support. Use with WebP/JPEG fallback." cta="Check browser support" href="https://caniuse.com/jpegxl">(?)</Tooltip> | `https://img-src.io/i/username/photo.jxl` |
