...
| **JXL** <Tooltip tip="Very limited browser support (~12%). Only Safari 17+ partial support. Chrome, Firefox, Edge do not display JXL by default. Use with WebP/JPEG fallback." cta="Check browser support" href="https://caniuse.com/jpegxl">(?)</Tooltip> | `.jxl` | Next-gen compression |
